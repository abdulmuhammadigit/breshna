...
namespace Pro.Controllers
{
    ...
    public class OwnerController : Controller
    {
        ...
        {
            string _templatefile = AppConfig.FileBase + "House_Owner.xlsx";
            string _file = AppConfig.DownloadBase + "House_Owner" + ".xlsx";
            var ids = Data.Split(",");
            if (Data.Any())
            ...
            using (ExcelPackage p = new ExcelPackage())
            {
                ...
                foreach (var id in ids)
                {
                    ...
                    var owner = _context.Owners.Find(id.ToInt());
                    var family = _context.Residents.Where(a => a.OwnerId == id.ToInt()).ToList();
                    var metar = _context.PowerMeters.Where(a => a.OwnerId == id.ToInt()).ToList();
                    var equipmentHs = _context.EEquipmentHs.Where(a => a.OwnerId == id.ToInt()).ToList();
                    var warmings = _context.OwnerTypeWarmings.Where(a => a.OwnerId == id.ToInt()).ToList();
                    var equipmentComs = _context.EEquipmentComs.Where(a => a.OwnerId == id.ToInt()).ToList();
                    var language = _context.OwnerLanguages.Where(a => a.OwnerId == id.ToInt()).ToList();
                    ...
                    worksheet.Cells["L" + row].Value = owner.TypeIncome;
                    worksheet.Cells["M" + row].Value = owner.IncomeMonth;
                    worksheet.Cells["N" + row].Value = owner.Province;
                    worksheet.Cells["O" + row].Value = owner.Village;
                    worksheet.Cells["P" + row].Value = owner.Ghozar;
                    worksheet.Cells["Q" + row].Value = owner.HouseNumber;
                    worksheet.Cells["R" + row].Value = owner.ProvinceLive;
                    worksheet.Cells["S" + row].Value = owner.VillageLive;
                    worksheet.Cells["T" + row].Value = owner.GhozarLive;
                    worksheet.Cells["U" + row].Value = owner.ProvinceLive;
                    worksheet.Cells["V" + row].Value = owner.LiveWF;
                    worksheet.Cells["W" + row].Value = owner.LiveWFAge;
                    worksheet.Cells["X" + row].Value = owner.CountLiveINFamily;
                    ...
                    worksheet.Cells["BW" + row].Value = owner.EType;
                    worksheet.Cells["BX" + row].Value = owner.EMCount;
                    int colm = 77;
                    ...
                    worksheet.Cells["CG" + row].Value = owner.UseGenerator;
                    worksheet.Cells["CH" + row].Value = owner.CapacityG;
                    worksheet.Cells["CI" + row].Value = owner.HourUG;
                    worksheet.Cells["CJ" + row].Value = owner.WhenUG;
                    worksheet.Cells["CK" + row].Value = owner.ExpenseG;
                    worksheet.Cells["CL" + row].Value = owner.SourceE;
                    worksheet.Cells["CM" + row].Value = owner.EType;
                    int rowEqui = 92;
                    ...
                    worksheet.Cells["ES" + row].Value = owner.Room;
                    worksheet.Cells["ET" + row].Value = owner.Floor;
                    worksheet.Cells["EU" + row].Value = owner.WC;
                    worksheet.Cells["EV" + row].Value = owner.Kichen;
                    worksheet.Cells["EW" + row].Value = owner.TypeHome;
                    worksheet.Cells["EX" + row].Value = owner.AreaBuilding;
                    worksheet.Cells["EY" + row].Value = owner.Land;
                    worksheet.Cells["EZ" + row].Value = owner.AirCandition;

                    var warmingstaken = warmings.Take(1);
                    foreach (var item in warmings)
                    {
                        worksheet.Cells["FA" + row].Value = item.Name;

                    }

                    worksheet.Cells["FB" + row].Value = owner.HourOnStove;
                    worksheet.Cells["FC" + row].Value = owner.TradeHome;
                    worksheet.Cells["FD" + row].Value = owner.TypeTrade;
                    worksheet.Cells["FE" + row].Value = owner.TradeName;
                    worksheet.Cells["FF" + row].Value = owner.TradeYear;
                    worksheet.Cells["FG" + row].Value = owner.StaffCount;
                    ...
                    worksheet.Cells["GV" + row].Value = owner.BillRecive;
                    worksheet.Cells["GW" + row].Value = owner.BillDayDaily;
                    worksheet.Cells["GX" + row].Value = owner.GhastVar;
                    worksheet.Cells["GY" + row].Value = owner.ExpenseOld;
                    worksheet.Cells["GZ" + row].Value = owner.PayOnTime;
                    worksheet.Cells["HA" + row].Value = owner.EAlltime;
                    worksheet.Cells["HB" + row].Value = owner.EHour;
                    worksheet.Cells["HC" + row].Value = owner.WantEAT;
                    worksheet.Cells["HD" + row].Value = owner.PayForEAT;
                    worksheet.Cells["HE" + row].Value = owner.BSolor;
                    worksheet.Cells["HF" + row].Value = owner.SolorAmountAssets;

                    int lang = 1;
                    foreach (var item in language.Take(1))
                    {
                        worksheet.Cells["HG" + row].Value = item.Name;

                    }


                    worksheet.Cells["HH" + row].Value = owner.EmailAddress;
                    worksheet.Cells["HI" + row].Value = owner.WayContact;
                    worksheet.Cells["HJ" + row].Value = owner.Rezayat;
                    worksheet.Cells["HK" + row].Value = owner.Suggestion;
                    #endregion
                    row++;
