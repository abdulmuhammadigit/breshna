...
namespace Pro.ViewModels.Owner
{
   public class OwnerViewModel
    {
        public string JaktionNumber { get; set; }
        public string Reazyat { get; set; }
        ...
        public List<PowerMeter> PowerMeters { get; set; }
        public List<Resident> Residents { get; set; }
        public List<EEquipmentH> EEquipmentHs { get; set; }
        public List<EEquipmentCom> EEquipmentComs { get; set; }
