...
namespace Pro.Entities
{
    public class Owner
    {
        ...
        public string OwnerSave { get; set; }
       ...
       public string Rezayat { get; set; }
        ...
        public virtual ICollection<PowerMeter> PowerMeters { get; set; }
        public virtual ICollection<EEquipmentH> EEquipmentHs { get; set; }
        public virtual ICollection<EEquipmentCom> EEquipmentComs { get; set; }
        public virtual ICollection<OwnerLanguage> Languages { get; set; }
